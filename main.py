...
parser.add_argument("-i", "--ignore", metavar="", action="append", help="Files or dirs to ignore", default=["^\/?(?:[^/]+\/)*(\.[^/]+)$", "node_modules", "^.*\.(jpg|mp4|MP4|jpeg|JPG|gif|GIF|doc|DOC|pdf|PDF|lnk|png|bak|pypam|pam|log|csv|txt)$", "__pycache__", "package-lock.json"])
